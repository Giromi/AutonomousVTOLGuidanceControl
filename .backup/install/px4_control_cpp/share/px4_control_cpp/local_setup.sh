...
: ${AMENT_CURRENT_PREFIX:="/home/giromi/Repos/ws_sensor_combined_src/install/px4_control_cpp"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4_control_cpp/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4_control_cpp/environment/path.sh"
